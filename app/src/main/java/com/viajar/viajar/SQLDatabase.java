...
@Database(entities = {
        Location.class, Connection.class, Destination.class, LocationPortugal.class,
        LocationSpain.class, Concelho.class, Municipio.class, Comarca.class, Province.class},
        version = 1)
